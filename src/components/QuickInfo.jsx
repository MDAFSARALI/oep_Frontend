...
const QuickInfo = () => {
    return (
        <>
            <WhoUsesTitle>Who uses <b>OEP</b></WhoUsesTitle>
            <Container>
                <Section>
                    <Image><Person style={{ fontSize: "200px", color: "#393E46" }} /></Image>
                    <Info>
                        <Title>Individuals</Title>
                        <Description>Create fun social exam and send test link to your friends The review feature allows your friends to review their answers after they have completed the test.</Description>
                    </Info>
                </Section>
                <Section>
